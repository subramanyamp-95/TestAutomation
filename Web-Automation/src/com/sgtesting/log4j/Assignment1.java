...
public class Assignment1 {
	...
	public static Logger log1=Logger.getLogger("Automation Logs");
	...
	static void launchBrowser()
	{
		...
		try
		{
			log1.info("The LaunchBrowser method has started !!!");
			path=System.getProperty("user.dir");
			System.setProperty("webdriver.chrome.driver",path+"\\Library\\Drivers\\chromedriver.exe");
			getbrowser = new ChromeDriver();
			log1.info("The Chrome Browser has launched Succesfully");
			getbrowser.manage().window().maximize();
			log1.info("The Chrome Browser has maximized Succesfully");
			log1.info("The LaunchBrowser method has Ended !!! ");
		}catch(Exception e)
		{
			e.printStackTrace();
		}
