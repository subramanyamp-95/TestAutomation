...
public class Projects {
	...
	public static void createProject(WebDriver oBrowser)
	{
		try
		{
			...
			Thread.sleep(1000);			
			oBrowser.findElement(By.xpath("//input[@id='projectPopup_projectNameField']")).sendKeys("New-Project");Thread.sleep(1000);	
	...
	public static void modifyProject(WebDriver oBrowser)
	{
		try
		{
			...
			Thread.sleep(2000);
			oBrowser.findElement(By.xpath("//textarea[@class='textarea'][@placeholder='Enter project description...']")).sendKeys("Project description");
			Thread.sleep(2000);
